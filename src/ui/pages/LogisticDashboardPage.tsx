...
export const LogisticDashboardPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        // Buscamos el lote de este conductor
        ...
        if (myBatch && myBatch.orders) {
          ...
          // Próxima parada real (el primero pendiente)
      ...
      <header className="bg-white border-b border-slate-100 px-6 py-6 sticky top-0 z-30 shadow-sm">
        <div className="max-w-md mx-auto flex justify-between items-center">
          <div className="flex items-center gap-3">
             ...
             <div>
                <h1 className="text-lg font-black text-slate-900 tracking-tighter uppercase">Logística<span className="text-green-500">Operativa</span></h1>
             </div>
          </div>
          ...
          {view === 'summary' ? (
            ...
            >
              ...
              {nextOrder ? (
                ...
                <div className="bg-green-500 p-8 rounded-[2.5rem] text-white text-center shadow-xl shadow-green-100">
                   <CheckCircle2 size={40} className="mx-auto mb-4" />
                   <h3 className="text-2xl font-black tracking-tighter">¡Turno Completado!</h3>
                   <p className="text-green-100 text-sm font-medium mt-2">No tienes pedidos pendientes en tu lote actual.</p>
                </div>
              )}

              {/* IA Advisor Real para el Driver */}
